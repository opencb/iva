...
// sample stats CTs
const SAMPLE_STATS_CONSEQUENCE_TYPES = {
    style: {
        // This is the impact color. It allows to customise both the impact categories and desired colors
        high: "red",
        moderate: "darkorange",
    ...
    alias: [
        ...
        },
        {
            ...
            terms: ["frameshift_variant", "incomplete_terminal_codon_variant", "start_lost", "stop_gained", "stop_lost", "splice_acceptor_variant",
                "splice_donor_variant", "transcript_ablation", "inframe_deletion", "inframe_insertion", "missense_variant"]
        },
        {
            name: "Coding Sequence",
            description: "Filter Coding variants",
            terms: ["missense_variant", "stop_lost", "start_lost", "initiator_codon_variant", "frameshift_variant", "inframe_insertion", "inframe_deletion", "incomplete_terminal_codon_variant"]
        }
    ],
