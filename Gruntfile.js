        ...
        copy: {
            dist: {
                files: [
                    ...
                    // {   expand: true, cwd: "lib/jsorolla/src/core/webcomponents/opencga/variant/", src: ["*.js"], dest: "<%= build.path %>/jsorolla/lib/webcomponents/opencga/variant" },
                    // {   expand: true, cwd: "lib/jsorolla/src/core/data-adapter/", src: ["*.js"], dest: "<%= build.path %>/jsorolla/lib/data-adapter" },
                    // {   expand: true, cwd: "lib/jsorolla/src/core/visualisation/", src: ["*.js"], dest: "<%= build.path %>/jsorolla/lib/visualisation" },
                    // {   expand: true, cwd: "lib/jsorolla/src/core/widgets/feature/info/", src: ["*.js"], dest: "<%= build.path %>/jsorolla/lib/widgets/feature/info" },
                    // {   expand: true, cwd: "lib/jsorolla/src/core/widgets/", src: ["ux-window.js"], dest: "<%= build.path %>/jsorolla/lib/widgets" },
